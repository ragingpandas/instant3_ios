...
extension ParseLoginHelper : PFLogInViewControllerDelegate {
    ...
    func logInViewController(_ logInController: PFLogInViewController, didLogInUser user: PFUser) {
...
extension ParseLoginHelper : PFSignUpViewControllerDelegate {
    ...
    func signUpViewController(_ signUpController: PFSignUpViewController, didSignUpUser user: PFUser) {
        self.callback(user, nil)
    }
